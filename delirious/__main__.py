...
from delirious import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn

from delirious.modules import ALL_MODULES

from delirious.modules.helper_funcs.chat_status import is_user_admin

from delirious.modules.helper_funcs.misc import paginate_modules

from cinderella.modules.connection import connected

from delirious.modules.connection import connect_button

PM_START_TEXT = """

_Hello_ *{}*

_My name is_ *{}*\n_A Powerful Telegram Group AnimeBot Created to Manage Your Groups,Feel free to add to your groups!!_
...
I'm a anime group management bot with a few fun extras! Have a look at the following for an idea of some of \
...
if START_IMG is None:
    ...
    img = "https://telegra.ph/file/f7313e6a00751f07b8b1b.jpg"
...
for module_name in ALL_MODULES:
    ...
    imported_module = importlib.import_module("delirious.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="👨‍💻Commands👨‍💻",callback_data="help_back"),InlineKeyboardButton(text="🖥️Developer🖥️",url="https://t.me/hydroxy_op")]]

    keyboard += [[InlineKeyboardButton(text="🌐Connect Chat🌐", callback_data="main_connect"),InlineKeyboardButton(text="⚜️Add Me⚜️",url="t.me/{}?startgroup=true".format(bot.username))]]
        ...
        if mod_match:
            ...
            query.message.reply_text(text=text,
                                     ...
                                     reply_markup=InlineKeyboardMarkup(
                                         ...
                                         [[InlineKeyboardButton(text="🔙Previous🔙", callback_data="help_back")]]))
